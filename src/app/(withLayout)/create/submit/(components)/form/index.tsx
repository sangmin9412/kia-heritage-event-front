    ...
    async function checkPosterHydrated() {
      ...
      if (!_hasUserHydrated) {
        const userData: eventEnterFormSchemaType = {
          ...
          isOldKiaCar: String(response.data?.isOldKiaCar) as "true" | "false",
          oldKiaCar: response.data?.oldKiaCar || "",
          isCurrentKiaCar: String(response.data?.isCurrentKiaCar) as "true" | "false",
    ...
    try {
      ...
      formData.append(
        ...
        JSON.stringify({
          ...
          isOldKiaCar: userForm.isOldKiaCar === "true",
          oldKiaCar: userForm.oldKiaCar,
          isCurrentKiaCar: userForm.isCurrentKiaCar === "true",
          currentKiaCar: userForm.currentKiaCar,
          currentNonKiaCar: userForm.currentNonKiaCar,
