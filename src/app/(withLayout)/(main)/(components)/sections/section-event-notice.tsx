...
const NOTICE_ITEMS = [
  "<strong>1등 수상자는 12월에 진행 예정인 행사(시상식)에 참석이 필수적이며, 어려울 시 대리인 참석 부탁드립니다. (상세 내용은 당첨자 대상 개별 연락 예정)</strong>",
  "<strong>주최자는 수상작을 홍보 목적에 한하여 3년간 복제, 전시, 배포, 공중 송신할 수 있고, 입상자와 별도의 합의를 통한 이용 허락을 얻어 2차적 저작물을 작성할 수 있습니다.</strong>",
  ...
  "수상자는 2025년 11월 10일 이후, 기아닷컴 이벤트 게시판을 통해 공지될 예정입니다. ",
