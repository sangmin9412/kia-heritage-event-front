    ...
    <section className='relative py-[8rem]'>
      ...
      <div className='container'>
        <div className='flex flex-col gap-[4rem]'>
          ...
          <div>
            <div className='relative flex gap-[2.4rem]'>
              <div className='flex flex-col flex-1 bg-white'>
                <div className='p-[2.4rem_0] flex items-center gap-[2.4rem]'>
                  <div className='w-[10rem] h-[10rem] flex items-center justify-center bg-[#f8f8f8] rounded-full'>
                    <svg
                      width='48'
                      height='48'
                      viewBox='0 0 48 48'
                  ...
                  <div>
                    <p className='mb-[.8rem] text-[1.6rem] leading-[2.6rem] text-sub-text'>Step 01</p>
                    <h5 className='text-[2rem] leading-[3.2rem] font-bold'>나만의 포스터 만들기</h5>
                  </div>
                </div>

                <div className='p-[2.4rem_0.8rem] border-t border-border'>
              ...
              <div className='flex-[0_0_6rem] flex justify-center items-center'>
                <svg
                  width='32'
                  height='32'
                  viewBox='0 0 32 32'
              ...
              <div className='flex flex-col flex-1 bg-white'>
                <div className='p-[2.4rem_0] flex items-center gap-[2.4rem]'>
                  ...
                  <div>
                    <p className='mb-[.8rem] text-[1.6rem] leading-[2.6rem] text-sub-text'>Step 02</p>
                    <h5 className='text-[2rem] leading-[3.2rem] font-bold'>인스타그램 피드 인증하기</h5>
                  </div>
                </div>
                ...
                <div className='p-[2.4rem_0.8rem] border-t border-border'>
                  <DotList className='gap-[1.2rem]'>
                    ...
                    <DotItem className='text-[1.6rem] leading-[2.6rem] [--line-height:2.6rem]'>
                      ...
                      #기아80주년
                      <div className='pt-[1.2rem] flex items-center gap-[.8rem]'>
                        <button className='px-[0.8rem] text-[1.4rem] leading-[3.8rem] bg-[#f8f8f8]'>
                          #기아와함께한순간
                        </button>
                        <button className='px-[0.8rem] text-[1.4rem] leading-[3.8rem] bg-[#f8f8f8]'>
                          #기아헤리티지이벤트
                        </button>
                        <button className='px-[0.8rem] text-[1.4rem] leading-[3.8rem] bg-[#f8f8f8]'>#기아80주년</button>
                      </div>
                    </DotItem>
                    <DotItem className='text-[1.6rem] leading-[2.6rem] [--line-height:2.6rem]'>
