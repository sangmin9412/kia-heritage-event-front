  ...
  return (
    <main className='flex min-h-screen flex-col items-center justify-center p-24 bg-gray-50'>
      <div className='w-full max-w-2xl text-center'>
        <h1 className='text-4xl font-bold mb-4 text-gray-800'>Puppeteer on Vercel</h1>
        <p className='text-lg text-gray-600 mb-8'>
          Enter a URL below to generate a screenshot using Puppeteer running in a Vercel Function.
        </p>
        ...
        {screenshot && (
          <div className='mt-8 border border-gray-200 rounded-lg shadow-lg overflow-hidden'>
            <h2 className='text-2xl font-semibold p-4 bg-gray-100 border-b text-black'>Screenshot Preview</h2>
            <img src={screenshot || "/placeholder.svg"} alt='Website screenshot' className='w-full' />
          </div>
        )}
      </div>
    </main>
