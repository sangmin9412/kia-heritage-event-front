...
export const TermsAgreementField = ({ form }: { form: UseFormReturn<eventEnterFormSchemaType> }) => {
  ...
  return (
    <div className='pb-[3.2rem]'>
      <div className='mb-[2.4rem] py-[1.2rem] border-b border-primary'>
      ...
      <div className='flex flex-col gap-[2.4rem]'>
        <div>
          ...
          <div className='mt-[1.2rem] p-[1.6rem] min-h-[12rem] border-[2px] border-border'>
            <div className='text-[1.4rem] leading-[2.2rem] text-sub-text'>
      ...
      <div className='mt-[3.2rem]'>
        <div className='flex p-[1.6rem] bg-[#F8F8F8]'>
          <p className='flex-1 text-[1.4rem] leading-[2.2rem] text-sub-text text-center'>
